...
import com.example.kmovies.databinding.MovieLoadStateFooterBinding

class PlayingNowLoadStateAdapter (private val retry: ()-> Unit) : LoadStateAdapter<PlayingNowLoadStateAdapter.LoadStateViewHolder>(){
